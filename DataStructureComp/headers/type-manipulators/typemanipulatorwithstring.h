#ifndef TYPE_MANIPULATOR_WITH_STRING_H
#define TYPE_MANIPULATOR_WITH_STRING_H
 ...
 */
class TypeManipulatorWithString: public DataStructureTypeManipulator
{
public:
...
#endif // TYPE_MANIPULATOR_WITH_STRING_H
